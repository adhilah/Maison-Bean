        ...
        <div className="bg-white rounded-lg shadow-lg p-6 border border-amber-200">
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            <div>
              ...
              />
              {errors.password && (
                <p className="text-sm text-rose-600 mt-1">{errors.password}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-amber-800 hover:bg-amber-900 disabled:bg-amber-600 text-white py-3 rounded-lg font-semibold transition"
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-700">
              Don't have an account?{" "}
              <Link to="/registration" className="text-amber-800 font-medium hover:underline">
                Sign up
              </Link>
            </p>
          </div>
