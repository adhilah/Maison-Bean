    ...
    <div className="min-h-screen bg-[#faf9f7] py-10 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={() => navigate("/")}
            className="text-sm text-[#9c7635] font-medium hover:underline"
          >
            ← Back to Home
          </button>
        </div>
        ...
        {wishlist.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button
              onClick={() => navigate("/")}
              className="bg-[#9c7635] hover:bg-[#7a5c2a] text-white px-6 py-3 rounded-xl font-semibold transition"
            >
              Explore Menu
            </button>
          </div>
          ...
          <div className="space-y-5">
            {wishlist.map((item) => (
              <div
                key={item.id}
                onClick={() => setSelectedItem(item)}
                className="relative flex gap-5 bg-white rounded-2xl shadow hover:shadow-lg transition cursor-pointer p-4"
              >
                {/* REMOVE ICON */}
                <button
          ...
          {selectedItem && (
            <Dialog.Panel className="bg-white rounded-2xl max-w-xl w-full p-6 relative max-h-[90vh] overflow-y-auto">
              ...
              <button
                ...
                className="w-full mt-4 text-[#9c7635] font-medium hover:underline"
              >
                Remove from Wishlist
              </button>
            </Dialog.Panel>
