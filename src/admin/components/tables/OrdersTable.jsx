      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="px-8 py-6 border-b border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <Link
              to="/admin/dashboard"
              className="flex items-center gap-2 text-amber-800 font-medium hover:underline"
            >
              <ArrowLeft size={20} />
              Back to Dashboard
            </Link>
                  ...
                  return (
                    <tr 
                      ...
                      className={`hover:bg-gray-50 transition ${
                        order.status === "cancelled" ? "bg-red-50/40" : ""
                      }`}
                    >
                      <td className="px-8 py-6">
                        <span className="font-medium text-gray-900">
                      ...
                      <td className="px-8 py-6 text-right">
                        <div className="relative inline-block text-left">
                          <select
                            value={order.status || "pending"}
                            onChange={(e) => updateOrderStatus(order.id, e.target.value)}
                            className={`appearance-none border rounded-xl px-4 py-2 pr-8 text-sm font-medium cursor-pointer focus:outline-none focus:ring-2 focus:ring-amber-500 ${
