...
//  * - Allow admin to block/unblock users
//  * - Allow admin to permanently delete users
//  * - Provide easy navigation back to dashboard
//  */

// export default function UserManagement() {
//   // State for storing users from json-server
...
//   // Fetch users from json-server when component loads
//   useEffect(() => {
//     fetchUsers();
//   }, []);
...
//   // Delete user + all orders linked by userEmail
...
//   if (!window.confirm("Are you sure you want to delete this user and ALL their orders? This cannot be undone.")) {
//     return;
//   }
...
//       const deletePromises = userOrders.map(order => 
...
//     toast.success(`User and ${userOrders.length} order(s) deleted successfully`);
//   } catch (err) {
...
//                              className="px-5 py-2 text-[#b78838] bg-white rounded-xl font-medium hover:bg-[#7f602b] transition"
//                             title="Delete user"
//                           >
//                             <Trash2 size={18} />
//                           </button> */}
