...
// import { useEffect, useState } from "react";
// import axios from "axios";
// import { Search, Trash2, ArrowLeft, Ban, CheckCircle } from "lucide-react"; // ← Added Ban & CheckCircle
// import { Link } from "react-router-dom";
// import toast from "react-hot-toast";
...
//     toast.loading(`${newStatus ? "Blocking" : "Unblocking"} user...`);
...
//                   <th className="px-8 py-4">User</th>
//                   <th className="px-8 py-4">Email</th>
//                   <th className="px-8 py-4">Status</th> {/* ← NEW: Status column */}
//                   <th className="px-8 py-4">Join</th>
//                   <th className="px-8 py-4 text-right">Actions</th>
//                 </tr>
//               </thead>
...
//                 ) : filteredUsers.length === 0 ? (
//                   <tr>
//                     <td colSpan={5} className="px-8 py-16 text-center text-gray-500"> {/* ← Updated colSpan */}
//                       <p className="text-lg">No users found</p>
//                     </td>
//                   </tr>
//                 ) : (
...
//                     <tr
//                       key={user.id}
//                       className={`hover:bg-gray-50 transition ${user.isBlocked ? "bg-red-50" : ""}`}
//                     >
//                       <td className="px-8 py-6">
//                         <div className="flex items-center gap-4">
//                           <div className="h-10 w-10 rounded-full bg-amber-100 flex items-center justify-center">
...
//                           <button
//                             onClick={() => handleToggleBlock(user.id, user.isBlocked, user.email)}
...
export default function UserManagement() {
  ...
  // ← Block/Unblock Handler → Now updates "userStatus" in db.json
  const handleToggleBlock = async (userId, currentStatus, userEmail) => {
